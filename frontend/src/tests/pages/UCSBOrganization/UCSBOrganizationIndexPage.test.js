...
describe("UCSBOrganizationIndexPage tests", () => {
  ...
  test("what happens when you click delete, admin", async () => {
    ...
    axiosMock
      ...
      .reply(200, ucsbOrganizationFixtures.threeOrganizations);
    axiosMock
      .onDelete("/api/ucsborganization", { params: { orgCode: "CSB" } })
      .reply(200, "UCSB Organization with orgCode CSB was deleted");
    ...
    await waitFor(() => {
      expect(mockToast).toHaveBeenCalledWith(
        "UCSB Organization with orgCode CSB was deleted",
      );
    });
  });
});
