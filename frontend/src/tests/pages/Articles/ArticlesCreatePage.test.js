...
describe("ArticlesCreatePage tests", () => {
  ...
  test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
    ...
    fireEvent.change(nameField, { target: { value: "Sample Article" } });
    fireEvent.change(urlField, { target: { value: "https://example.com" } });
    fireEvent.change(explanationField, {
      target: { value: "This is a sample article" },
    });
    fireEvent.change(emailField, { target: { value: "sample@ucsb.edu" } });
    fireEvent.change(dateAddedField, { target: { value: "2024-02-02T00:00" } });
