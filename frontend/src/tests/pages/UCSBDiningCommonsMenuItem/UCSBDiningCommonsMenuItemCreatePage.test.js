...
describe("UCSBDiningCommonsMenuItemCreatePage tests", () => {
  ...
  test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
    ...
    fireEvent.change(nameField, { target: { value: "Spinach" } });
    ...
    expect(mockToast).toBeCalledWith(
      "New ucsbDiningCommonsMenuItem Created - id: 17 name: Spinach",
    );
    expect(mockNavigate).toBeCalledWith({ to: "/ucsbDiningCommonsMenuItem" }); //HERE?
  });
});
