...
public class UCSBDiningCommonsMenuItemWebIT extends WebTestCase {
    @Test
    public void admin_user_can_create_edit_delete_dcmi() throws Exception {
        setupUser(true);
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("Oven");
    ...
    @Test
    public void regular_user_cannot_create_dcmi() throws Exception {
        setupUser(false);
