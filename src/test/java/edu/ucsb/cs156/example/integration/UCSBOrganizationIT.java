...
public class UCSBOrganizationIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                ucsbOrgsRepository.save(skiing);
        ...
        public void an_admin_user_can_post_a_new_ucsborg() throws Exception {
                ...
                // act
                // orgCode=SNU&orgTranslationShort=SIGMA NU&orgTranslation=SIGMA NU FRATERNITY&inactive=true
                MvcResult response = mockMvc.perform(
                                post("/api/ucsborganization/post?orgCode=SKI&orgTranslationShort=SKIING CLUB&orgTranslation=SKIING CLUB AT UCSB&inactive=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
